# AtlasDynaTOGT：非凸时变窗口穿越方法

本目录是总任务 `nonconvex_timevarying_window/` 下的一种具体解决方法。它使用三角剖分 chart atlas 表示非凸窗口，并优化穿越时间、穿越点和轨迹。详细原理见 [ALGORITHM.md](ALGORITHM.md)。
...
```text
nonconvex_timevarying_window/atlas_dynatogt/results/<suite>/
  summary.csv
  trajectories/*.csv
  figures/*.png
  gifs/*.gif
